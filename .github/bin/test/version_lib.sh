...
# The lines `asbackup --version` / `asrestore --version` must print for that
# string. print_version() splits on "-": the core goes on the Version line and
# the last field, if any, on a Build line.
#
#   4.5.9-rc1        Version 4.5.9 / Build rc1
#   4.5.9-abc123def  Version 4.5.9 / Build abc123def
#   4.5.9            Version 4.5.9
