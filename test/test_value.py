...
LARGE_LIST_VALUES_MSG_PACK = [
	...
	[
		...
		{"key": 1, "blob": bytearray([])},
		{"key": 2, "blob": bytearray([42])},
		{"key": 3, "blob": bytearray([42] * 15)},
		{"key": 4, "blob": bytearray([42] * 16)},
		{"key": 5, "blob": bytearray([42] * 255)},
		{"key": 6, "blob": bytearray([42] * 256)},
		{"key": 7, "blob": bytearray([42] * 65535)},
		{"key": 8, "blob": bytearray([42] * 65536)},
		{"key": 9, "blob": bytearray([42] * 131072)},
		{"key": 10, "map": {}},
		{"key": 11, "map": {"a": 1}},
		{"key": 12, "map": LARGE_LIST_MAPS[15]},
		{"key": 13, "map": LARGE_LIST_MAPS[16]},
		{"key": 14, "map": LARGE_LIST_MAPS[255]},
		{"key": 15, "map": LARGE_LIST_MAPS[256]},
		{"key": 16, "map": LARGE_LIST_MAPS[65535]},
		{"key": 17, "map": LARGE_LIST_MAPS[65536]},
		{"key": 18, "map": LARGE_LIST_MAPS[131072]},
		{"key": 19, "list": []},
		{"key": 20, "list": [1]},
		{"key": 21, "list": [1] * 15},
		{"key": 22, "list": [1] * 16},
		...
		{"key": 25, "list": [1] * 65535},
		{"key": 26, "list": [1] * 65536},
		{"key": 27, "list": [1] * 131072},
		{"key": 28, "map": {"list1": [1, 2, 3], "list2": [4, 5, 6]}},
		{"key": 29, "list": [{"a": 1, "b": 2}, {"c": 3, "d": 4}]},
		{
			"key": 30,
