...
class RestoreConfigT(ComparableCtStructure):
	_fields_ = [
		...
		("login_timeout", ctypes.c_uint32),
		("retry_delay", ctypes.c_uint32),
		("async_min_conns_per_node", ctypes.c_uint32),
		("async_max_conns_per_node", ctypes.c_uint32),
		("error_rate_window", ctypes.c_uint32),
		("max_error_rate", ctypes.c_uint32),
		("disable_batch_writes", ctypes.c_bool),
		("max_async_batches", ctypes.c_uint32),
		("batch_size", ctypes.c_uint32),
		("event_loops", ctypes.c_uint32),
		("max_commands_in_process", ctypes.c_uint32),
		("max_commands_in_queue", ctypes.c_uint32),
